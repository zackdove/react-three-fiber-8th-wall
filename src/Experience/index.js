...
const Component = ({ XR8, xr8Config, onComplete, backgroundImage, }) => {
    ...
    return (
    	<Canvas concurrent={true} style={{ width:'100%', height:'100%', position:'absolute', left:'0px', top:'0px', zIndex:100  }} shadows updateDefaultCamera={false} camera={{position: [0, 0, 5], fov: 60 }}>
